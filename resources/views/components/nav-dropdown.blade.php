...
<div class="group relative">
    <button class="flex items-center gap-1 rounded-lg px-3.5 py-2 text-[15px] font-medium text-navy-800 transition hover:bg-stone-100 hover:text-navy-900">
        {{ $label }}
    ...
    <div class="invisible absolute left-0 top-full z-50 min-w-56 translate-y-1 pt-2 opacity-0 transition-all duration-200 group-hover:visible group-hover:translate-y-0 group-hover:opacity-100">
        <div class="overflow-hidden rounded-xl border border-stone-200 bg-white py-2 shadow-card-lg">
