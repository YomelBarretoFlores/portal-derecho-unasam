...
>
    <nav class="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 transition-all duration-300"
        ...
        <div class="flex items-center gap-3">
            ...
            <button @click="mobile = !mobile" class="lg:hidden text-navy-900" aria-label="Menú">
    ...
    <div x-show="mobile" x-cloak
        ...
        <div class="space-y-1 px-6 py-4">
            ...
            <a href="https://unasam.edu.pe" target="_blank" rel="noopener" class="btn btn-sm btn-primary mt-3 w-full">Portal UNASAM ↗</a>
        </div>
    </div>
</header>
