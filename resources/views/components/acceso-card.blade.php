...
<a href="{{ $href }}" wire:navigate.hover class="group flex min-h-40 flex-col bg-white p-6 transition-colors hover:bg-navy-950 md:p-7">
    <div class="flex items-start justify-between gap-5">
        ...
        <svg aria-hidden="true" class="h-5 w-5 text-stone-300 transition group-hover:translate-x-1 group-hover:text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path d="M5 12h14M13 6l6 6-6 6"/></svg>
    </div>
