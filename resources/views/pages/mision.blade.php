...
@section('content')
    ...
    <section class="mx-auto max-w-7xl px-6 py-20">
        <div class="grid gap-8 lg:grid-cols-2">
            {{-- Misión (oscura) --}}
            <x-reveal>
                <div class="flex h-full flex-col bg-navy-900 p-10 text-white">
                    <h2 class="font-sans text-xs font-semibold uppercase tracking-[0.14em] text-white/65">Misión</h2>
            ...
            {{-- Visión (clara) --}}
            <x-reveal :delay="0.12">
                <div class="flex h-full flex-col border border-stone-200 bg-paper p-10">
