    ...
    <section class="mx-auto max-w-7xl px-6 py-20">
        <div class="grid gap-16 lg:grid-cols-[1fr_360px]">
            ...
            <div class="reveal max-w-2xl">
                ...
                <h2 class="mt-5 text-3xl font-semibold text-navy-900">Bienvenido al Programa de Estudio de Derecho y Ciencias Políticas</h2>
            ...
            <aside class="reveal" data-reveal-delay="0.12">
                <div class="rounded-2xl border border-gray-200 bg-gray-50 p-7">
                    ...
                    <dl class="mt-5 space-y-4 font-sans text-sm">
                        @foreach ([
                            ...
                            <div class="flex justify-between gap-4 border-b border-gray-200 pb-3">
