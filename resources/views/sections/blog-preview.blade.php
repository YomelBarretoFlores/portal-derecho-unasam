...
<section class="mx-auto max-w-7xl px-6 py-24">
    <div class="reveal flex flex-wrap items-end justify-between gap-4">
        <div>
            ...
            <h2 class="mt-2 text-3xl font-semibold text-navy-900 md:text-4xl">Noticias, opiniones y eventos</h2>
        </div>
        <a href="{{ route('blog') }}" wire:navigate class="group inline-flex items-center gap-1.5 font-sans text-sm font-semibold text-navy-700">
            Ver todo el blog
